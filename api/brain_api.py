...
# P3.5: removed the dead second `app = FastAPI()` / `app.include_router(router)` instance that
# lived here — main.py imports `router` and mounts it on the real app; tests use api.main.app.
